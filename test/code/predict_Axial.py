...
class CTDataset(Dataset):
    ...
    def __getitem__(self, index):
        header_slices = '../data/slices/axial/'
        ...
        slice_number = int(self.df.at[self.df.index[index], 'axial_slice'])
...
logger.info('do_train: {}, batch_size: {}, predictor: {},  saving to: {}, '.format(do_train,  batch_size, predictor, save_dir))
